...
@onready var total_views = $stats2/Views/viewamount
@onready var total_vids = $stats2/vids/vidamount
@onready var channelmon = $channelmon
@onready var monetize_status = $monetizestatus
@onready var total_earnings = $stats2/earnings/earningamount
...
signal n_mode_enabled
signal g_mode_enabled
